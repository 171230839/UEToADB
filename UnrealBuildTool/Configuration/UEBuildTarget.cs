...
namespace UnrealBuildTool
{
	...
	class UEBuildTarget
	{
		...
		static void ValidateSharedEnvironment(RulesAssembly RulesAssembly, string ThisTargetName, CommandLineArguments Arguments, TargetRules ThisRules)
		{
			...
			bool bUsesTargetReceiptToEnablePlugins = ((ThisRules.Type == TargetType.Editor || ThisRules.Type == TargetType.App) && ThisRules.LinkType != TargetLinkType.Monolithic);
		...
		{
			if (TargetType != TargetType.Editor && TargetType != TargetType.App && TargetType != TargetType.Program && Configuration == UnrealTargetConfiguration.Shipping &&
		...
		public static bool IsRedistributable(UEBuildModule Module)
		{
			...
			if(Module.RulesFile != null)
			{
				...
				//{
					DirectoryReference SourceDeveloperDir = DirectoryReference.Combine(UnrealBuildTool.EngineSourceDirectory, "Developer");
		...
		protected void AddAllValidModulesToTarget()
		{
			...
			if (TargetType != TargetType.Program)
			{
				...
				if (TargetType == TargetType.Editor || TargetType == TargetType.App)
				{
					Directories.AddRange(UnrealBuildTool.GetExtensionDirs(UnrealBuildTool.EngineSourceDirectory, "Editor"));
				}
				Directories.AddRange(UnrealBuildTool.GetExtensionDirs(UnrealBuildTool.EngineSourceDirectory, "Runtime"));
				...
				{
					Directories.AddRange(UnrealBuildTool.GetExtensionDirs(UnrealBuildTool.EngineSourceDirectory, "Developer"));
				}
		...
		public void SetupPlugins()
		{
			...
			bool bAllowEnginePluginsEnabledByDefault = Rules.bBuildAllPlugins;
